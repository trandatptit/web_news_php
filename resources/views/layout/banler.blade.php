                ...
                <div class="swiper sliderFeaturedPosts">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <a href="{{ $v->link }}" class="img-bg d-flex align-items-end" target="blank"
                                style="background-image: url('{{ asset('images/banler/'.$v->hinh) }}');">
                        ...
                        {{-- <div class="swiper-slide">
                            <a href="single-post.html" class="img-bg d-flex align-items-end"
                                style="background-image: url('{{ asset('user') }}/img/post-slide-2.jpg');">
                                <div class="img-bg-inner">
                        ...
                        <div class="swiper-slide">
                            <a href="single-post.html" class="img-bg d-flex align-items-end"
                                style="background-image: url('{{ asset('user') }}/img/post-slide-3.jpg');">
                                <div class="img-bg-inner">
                        ...
                        <div class="swiper-slide">
                            <a href="single-post.html" class="img-bg d-flex align-items-end"
                                style="background-image: url('{{ asset('user') }}/img/post-slide-4.jpg');">
                                <div class="img-bg-inner">
