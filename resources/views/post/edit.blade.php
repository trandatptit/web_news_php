        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action=" {{ url('admin/posts/edit/'. $Post->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea required name="excerpt" class="form-control" id="inputProductDescription" rows="3" >{{ $Post->excerpt }}</textarea>
                                                        ...
                                                        <div class="mb-3">
                                                            <select name="category_id" required class="select">
                                                                @foreach ($Category as $k => $v)
                                                                    <option value="{{ $v->id }}" @if($v->id == $Post->category_id) selected @endif>
                                                                        {{ $v->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p>
                                                <img width="300px" src="{{ asset('images/avatar_post/'.$Post->avatar) }} " alt="">
                                            </p>
                                        ...
                                        <div class="mb-3">
                                            <label for="inputProductDescription" class="form-label">Nội dung bài
                                                viết</label>
                                            <textarea name="body" id="post_content" class="form-control" id="inputProductDescription" rows="3">{{$Post->body}}</textarea>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                ...
                                                <input name="approved" {{ $Post->approved ? 'checked' : '' }} class="form-check-input" type="checkbox" value="1" id="flexSwitchChecked">
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                        <thead>
                            <tr>
                                ...
                                <th class="text_align_center">Ngày bình luận</th>
                                ...
                                @foreach ($Post->comments as $k => $v)
                                    <tr class="odd">
                                        ...
                                        <td class="text_align_center">
                                            {{ \Carbon\Carbon::parse($v->created_at)->format('H:i:s d/m/Y') }}
                                        </td>
                                        <td class="text_align_center">
                                            <a href="{{url('admin/posts/comment/delete/'.$v->id)}}" title="xóa" class="ad_button_delete">
